...
def start(window):
    ...
    img = img.resize((300, 250), Image.BICUBIC if hasattr(Image, 'BICUBIC') else 3)
    ...
    img2 = img2.resize((200, 150), Image.BICUBIC if hasattr(Image, 'BICUBIC') else Image.BICUBIC)
    img2 = img2.resize((200, 150), Image.BICUBIC)
    ...
    img3 = img3.resize((200, 150), Image.BICUBIC)
    ...
    img4 = img4.resize((200, 150), Image.BICUBIC)
    ...
    img5 = img5.resize((200, 150), Image.BICUBIC)
